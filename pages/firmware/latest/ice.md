---
title: Redmi A1/POCO C50/A1+ (ice) Firmware Downloads
layout: download
name: Redmi A1/POCO C50/A1+
codename: ice
permalink: /firmware/ice/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/ice/">Redmi A1/POCO C50/A1+</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/ice/" class="card-link">Firmware Archive</a>
    <a href="/miui/ice/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('ice', 'latest')</script>
            </table>
        </div>
    </div>
