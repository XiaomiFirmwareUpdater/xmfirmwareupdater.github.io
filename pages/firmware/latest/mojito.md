---
title: Redmi Note 10 (mojito) Firmware Downloads
layout: download
name: Redmi Note 10
codename: mojito
permalink: /firmware/mojito/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/mojito/">Redmi Note 10</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/mojito/" class="card-link">Firmware Archive</a>
    <a href="/miui/mojito/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('mojito', 'latest')</script>
            </table>
        </div>
    </div>
