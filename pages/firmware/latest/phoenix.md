---
title: Redmi K30 4G (phoenix) Firmware Downloads
layout: download
name: Redmi K30 4G
codename: phoenix
permalink: /firmware/phoenix/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/phoenix/">Redmi K30 4G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/phoenix/" class="card-link">Firmware Archive</a>
    <a href="/miui/phoenix/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('phoenix', 'latest')</script>
            </table>
        </div>
    </div>
