---
title: Redmi Note 14 4G (tanzanite) Firmware Downloads
layout: download
name: Redmi Note 14 4G
codename: tanzanite
permalink: /firmware/tanzanite/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/tanzanite/">Redmi Note 14 4G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/tanzanite/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/tanzanite/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('tanzanite', 'latest')</script>
            </table>
        </div>
    </div>
