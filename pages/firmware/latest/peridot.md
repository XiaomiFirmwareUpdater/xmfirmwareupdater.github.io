---
title: Redmi Turbo 3/POCO F6 (peridot) Firmware Downloads
layout: download
name: Redmi Turbo 3/POCO F6
codename: peridot
permalink: /firmware/peridot/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/peridot/">Redmi Turbo 3/POCO F6</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/peridot/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/peridot/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('peridot', 'latest')</script>
            </table>
        </div>
    </div>
