---
title: MIX Fold 4 (goku) Firmware Downloads
layout: download
name: MIX Fold 4
codename: goku
permalink: /firmware/goku/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/goku/">MIX Fold 4</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/goku/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/goku/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('goku', 'latest')</script>
            </table>
        </div>
    </div>
