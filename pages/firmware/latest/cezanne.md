---
title: Redmi K30 Ultra (cezanne) Firmware Downloads
layout: download
name: Redmi K30 Ultra
codename: cezanne
permalink: /firmware/cezanne/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/cezanne/">Redmi K30 Ultra</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/cezanne/" class="card-link">Firmware Archive</a>
    <a href="/miui/cezanne/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('cezanne', 'latest')</script>
            </table>
        </div>
    </div>
