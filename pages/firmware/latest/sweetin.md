...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/sweetin/" class="card-link">Firmware Archive</a>
    <a href="/miui/sweetin/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('sweetin', 'latest')</script>
            </table>
        </div>
    </div>
