---
title: Xiaomi 12 Pro Dimensity (daumier) Firmware Downloads
layout: download
name: Xiaomi 12 Pro Dimensity
codename: daumier
permalink: /firmware/daumier/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/daumier/">Xiaomi 12 Pro Dimensity</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/daumier/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/daumier/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('daumier', 'latest')</script>
            </table>
        </div>
    </div>
