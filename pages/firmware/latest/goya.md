---
title: Xiaomi 15T (goya) Firmware Downloads
layout: download
name: Xiaomi 15T
codename: goya
permalink: /firmware/goya/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/goya/">Xiaomi 15T</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/goya/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/goya/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('goya', 'latest')</script>
            </table>
        </div>
    </div>
