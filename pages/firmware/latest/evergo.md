---
title: Redmi Note 11 5G/Redmi Note 11T 5G (evergo) Firmware Downloads
layout: download
name: Redmi Note 11 5G/Redmi Note 11T 5G
codename: evergo
permalink: /firmware/evergo/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/evergo/">Redmi Note 11 5G/Redmi Note 11T 5G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/evergo/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/evergo/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('evergo', 'latest')</script>
            </table>
        </div>
    </div>
