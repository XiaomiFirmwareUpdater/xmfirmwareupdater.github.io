---
title: Redmi Note 9 Pro (curtana) Firmware Downloads
layout: download
name: Redmi Note 9 Pro
codename: curtana
permalink: /firmware/curtana/
---
...
##### This page shows the latest downloads only. If you're looking for old releases check [the archive](/archive/firmware/curtana/).
...
<table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
    ...
    <script>loadFirmwareDownloads('curtana', 'latest')</script>
</table>
</div>
