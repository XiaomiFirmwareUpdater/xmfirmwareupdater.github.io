---
title: Redmi Pad SE 8.7 5G (flare) Firmware Downloads
layout: download
name: Redmi Pad SE 8.7 5G
codename: flare
permalink: /firmware/flare/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/flare/">Redmi Pad SE 8.7 5G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/flare/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/flare/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('flare', 'latest')</script>
            </table>
        </div>
    </div>
