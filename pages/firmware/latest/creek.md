---
title: Redmi 15/POCO M7 (creek) Firmware Downloads
layout: download
name: Redmi 15/POCO M7
codename: creek
permalink: /firmware/creek/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/creek/">Redmi 15/POCO M7</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/creek/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/creek/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('creek', 'latest')</script>
            </table>
        </div>
    </div>
