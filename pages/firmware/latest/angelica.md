---
title: Redmi 9C (angelica) Firmware Downloads
layout: download
name: Redmi 9C
codename: angelica
permalink: /firmware/angelica/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/angelica/">Redmi 9C</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/angelica/" class="card-link">Firmware Archive</a>
    <a href="/miui/angelica/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('angelica', 'latest')</script>
            </table>
        </div>
    </div>
