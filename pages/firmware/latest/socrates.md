---
title: Redmi K60 Pro (socrates) Firmware Downloads
layout: download
name: Redmi K60 Pro
codename: socrates
permalink: /firmware/socrates/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/socrates/">Redmi K60 Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/socrates/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/socrates/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('socrates', 'latest')</script>
            </table>
        </div>
    </div>
