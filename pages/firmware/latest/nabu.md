---
title: Xiaomi Pad 5 (nabu) Firmware Downloads
layout: download
name: Xiaomi Pad 5
codename: nabu
permalink: /firmware/nabu/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/nabu/">Xiaomi Pad 5</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/nabu/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/nabu/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('nabu', 'latest')</script>
            </table>
        </div>
    </div>
