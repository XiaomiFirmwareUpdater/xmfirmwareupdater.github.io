---
title: Xiaomi Pad 5 Pro 5G (enuma) Firmware Downloads
layout: download
name: Xiaomi Pad 5 Pro 5G
codename: enuma
permalink: /firmware/enuma/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/enuma/">Xiaomi Pad 5 Pro 5G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/enuma/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/enuma/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('enuma', 'latest')</script>
            </table>
        </div>
    </div>
