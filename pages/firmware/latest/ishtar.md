---
title: Xiaomi 13 Ultra (ishtar) Firmware Downloads
layout: download
name: Xiaomi 13 Ultra
codename: ishtar
permalink: /firmware/ishtar/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/ishtar/">Xiaomi 13 Ultra</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/ishtar/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/ishtar/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('ishtar', 'latest')</script>
            </table>
        </div>
    </div>
