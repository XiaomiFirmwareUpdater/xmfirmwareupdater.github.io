---
title: Redmi Note 9 5G (cannon) Firmware Downloads
layout: download
name: Redmi Note 9 5G
codename: cannon
permalink: /firmware/cannon/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/cannon/">Redmi Note 9 5G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/cannon/" class="card-link">Firmware Archive</a>
    <a href="/miui/cannon/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('cannon', 'latest')</script>
            </table>
        </div>
    </div>
