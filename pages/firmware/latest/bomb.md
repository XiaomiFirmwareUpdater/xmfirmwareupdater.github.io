---
title: Redmi 10X Pro (bomb) Firmware Downloads
layout: download
name: Redmi 10X Pro
codename: bomb
permalink: /firmware/bomb/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/bomb/">Redmi 10X Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/bomb/" class="card-link">Firmware Archive</a>
    <a href="/miui/bomb/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('bomb', 'latest')</script>
            </table>
        </div>
    </div>
