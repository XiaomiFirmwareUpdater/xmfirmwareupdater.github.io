---
title: Xiaomi 13T (aristotle) Firmware Downloads
layout: download
name: Xiaomi 13T
codename: aristotle
permalink: /firmware/aristotle/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/aristotle/">Xiaomi 13T</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/aristotle/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/aristotle/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('aristotle', 'latest')</script>
            </table>
        </div>
    </div>
