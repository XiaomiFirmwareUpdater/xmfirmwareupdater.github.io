---
title: Xiaomi Civi 5 Pro (luming) Firmware Downloads
layout: download
name: Xiaomi Civi 5 Pro
codename: luming
permalink: /firmware/luming/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/luming/">Xiaomi Civi 5 Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/luming/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/luming/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('luming', 'latest')</script>
            </table>
        </div>
    </div>
