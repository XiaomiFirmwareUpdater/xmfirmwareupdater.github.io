---
title: Xiaomi 12S Pro (unicorn) Firmware Downloads
layout: download
name: Xiaomi 12S Pro
codename: unicorn
permalink: /firmware/unicorn/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/unicorn/">Xiaomi 12S Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/unicorn/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/unicorn/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('unicorn', 'latest')</script>
            </table>
        </div>
    </div>
