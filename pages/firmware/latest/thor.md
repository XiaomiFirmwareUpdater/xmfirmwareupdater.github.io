---
title: Xiaomi 12S Ultra (thor) Firmware Downloads
layout: download
name: Xiaomi 12S Ultra
codename: thor
permalink: /firmware/thor/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/thor/">Xiaomi 12S Ultra</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/thor/" class="card-link">Firmware Archive</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('thor', 'latest')</script>
            </table>
        </div>
    </div>
