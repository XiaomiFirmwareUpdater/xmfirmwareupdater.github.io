---
title: POCO X5 5G (moonstone) Firmware Downloads
layout: download
name: POCO X5 5G
codename: moonstone
permalink: /firmware/moonstone/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/moonstone/">POCO X5 5G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/moonstone/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/moonstone/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('moonstone', 'latest')</script>
            </table>
        </div>
    </div>
