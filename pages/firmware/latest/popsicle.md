---
title: Xiaomi 17 Pro Max (popsicle) Firmware Downloads
layout: download
name: Xiaomi 17 Pro Max
codename: popsicle
permalink: /firmware/popsicle/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/popsicle/">Xiaomi 17 Pro Max</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/popsicle/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/popsicle/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('popsicle', 'latest')</script>
            </table>
        </div>
    </div>
