---
title: Redmi Note 10S (rosemary) Firmware Downloads
layout: download
name: Redmi Note 10S
codename: rosemary
permalink: /firmware/rosemary/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/rosemary/">Redmi Note 10S</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/rosemary/" class="card-link">Firmware Archive</a>
    <a href="/miui/rosemary/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('rosemary', 'latest')</script>
            </table>
        </div>
    </div>
