...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/corot/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/corot/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('corot', 'latest')</script>
            </table>
        </div>
    </div>
