---
title: Redmi Note 12 Turbo/POCO F5 (marble) Firmware Downloads
layout: download
name: Redmi Note 12 Turbo/POCO F5
codename: marble
permalink: /firmware/marble/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/marble/">Redmi Note 12 Turbo/POCO F5</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/marble/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/marble/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('marble', 'latest')</script>
            </table>
        </div>
    </div>
