---
title: Redmi 10C (fog) Firmware Downloads
layout: download
name: Redmi 10C
codename: fog
permalink: /firmware/fog/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/fog/">Redmi 10C</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/fog/" class="card-link">Firmware Archive</a>
    <a href="/miui/fog/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('fog', 'latest')</script>
            </table>
        </div>
    </div>
