---
title: Redmi Pad Pro/POCO Pad (dizi) Firmware Downloads
layout: download
name: Redmi Pad Pro/POCO Pad
codename: dizi
permalink: /firmware/dizi/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/dizi/">Redmi Pad Pro/POCO Pad</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/dizi/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/dizi/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('dizi', 'latest')</script>
            </table>
        </div>
    </div>
