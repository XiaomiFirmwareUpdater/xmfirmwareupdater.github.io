---
title: Redmi K90 Max (prague) Firmware Downloads
layout: download
name: Redmi K90 Max
codename: prague
permalink: /firmware/prague/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/prague/">Redmi K90 Max</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/prague/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/prague/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('prague', 'latest')</script>
            </table>
        </div>
    </div>
