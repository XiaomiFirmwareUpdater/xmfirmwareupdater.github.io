...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/spark/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/spark/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('spark', 'latest')</script>
            </table>
        </div>
    </div>
