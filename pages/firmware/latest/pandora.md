---
title: Xiaomi 17 Pro (pandora) Firmware Downloads
layout: download
name: Xiaomi 17 Pro
codename: pandora
permalink: /firmware/pandora/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/pandora/">Xiaomi 17 Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/pandora/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/pandora/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('pandora', 'latest')</script>
            </table>
        </div>
    </div>
