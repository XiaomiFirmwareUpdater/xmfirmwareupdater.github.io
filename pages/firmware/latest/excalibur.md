---
title: Redmi Note 9 Pro Max (excalibur) Firmware Downloads
layout: download
name: Redmi Note 9 Pro Max
codename: excalibur
permalink: /firmware/excalibur/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/excalibur/">Redmi Note 9 Pro Max</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/excalibur/" class="card-link">Firmware Archive</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('excalibur', 'latest')</script>
            </table>
        </div>
    </div>
