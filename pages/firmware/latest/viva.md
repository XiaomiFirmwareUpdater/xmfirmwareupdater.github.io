---
title: Redmi Note 11 Pro 4G (viva) Firmware Downloads
layout: download
name: Redmi Note 11 Pro 4G
codename: viva
permalink: /firmware/viva/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/firmware/">Firmware</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/firmware/viva/">Redmi Note 11 Pro 4G</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/firmware/viva/" class="card-link">Firmware Archive</a>
    <a href="/hyperos/viva/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        ...
        <div class="table-responsive-md" style="margin-top: 25px;">
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('viva', 'latest')</script>
            </table>
        </div>
    </div>
