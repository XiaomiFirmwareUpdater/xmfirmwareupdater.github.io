...
codename: selenes
permalink: /archive/firmware/selenes/
---
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/selenes/" class="card-link">Latest Firmware</a>
    <a href="/miui/selenes/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('selenes', 'full')</script>
            </table>
        </div>
    </div>
