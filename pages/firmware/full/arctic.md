...
codename: arctic
permalink: /archive/firmware/arctic/
---
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/arctic/" class="card-link">Latest Firmware</a>
    <a href="/hyperos/arctic/" class="card-link">HyperOS Downloads</a>
    <a href="/vendor/arctic/" class="card-link">Vendor Downloads</a>
  </div>
</div>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('arctic', 'full')</script>
            </table>
        </div>
    </div>
