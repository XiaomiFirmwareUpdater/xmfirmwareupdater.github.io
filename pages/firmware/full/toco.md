...
codename: toco
permalink: /archive/firmware/toco/
---

### Firmware Archive
##### This page shows all available downloads. If you're looking for the latest releases check [Here](/firmware/toco/).
...
<table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
    ...
    <script>loadFirmwareDownloads('toco', 'full')</script>
</table>
</div>
