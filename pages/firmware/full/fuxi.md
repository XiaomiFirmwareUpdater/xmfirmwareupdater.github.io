...
name: Xiaomi 13
codename: fuxi
permalink: /archive/firmware/fuxi/
---
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/fuxi/" class="card-link">Latest Firmware</a>
    <a href="/miui/fuxi/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('fuxi', 'full')</script>
            </table>
        </div>
    </div>
