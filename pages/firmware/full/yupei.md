...
name: Xiaomi Pad 8
codename: yupei
permalink: /archive/firmware/yupei/
---
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/yupei/" class="card-link">Latest Firmware</a>
    <a href="/hyperos/yupei/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('yupei', 'full')</script>
            </table>
        </div>
    </div>
