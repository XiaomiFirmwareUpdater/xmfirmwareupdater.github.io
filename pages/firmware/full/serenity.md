...
codename: serenity
permalink: /archive/firmware/serenity/
---
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/serenity/" class="card-link">Latest Firmware</a>
    <a href="/miui/serenity/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('serenity', 'full')</script>
            </table>
        </div>
    </div>
