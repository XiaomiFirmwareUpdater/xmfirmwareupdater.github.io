...
codename: picasso
permalink: /archive/firmware/picasso/
---

### Firmware Archive
##### This page shows all available downloads. If you're looking for the latest releases check [Here](/firmware/picasso/).
...
<table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
    ...
    <script>loadFirmwareDownloads('picasso', 'full')</script>
</table>
</div>
