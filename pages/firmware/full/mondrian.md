...
<div class="card">
  <div class="card-body">
    ...
    <a href="/firmware/mondrian/" class="card-link">Latest Firmware</a>
    <a href="/hyperos/mondrian/" class="card-link">HyperOS Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="firmware" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadFirmwareDownloads('mondrian', 'full')</script>
            </table>
        </div>
    </div>
