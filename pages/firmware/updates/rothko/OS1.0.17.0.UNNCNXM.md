---
title: Redmi K70 Ultra China Firmware OS1.0.17.0.UNNCNXM Update
layout: download
name: Redmi K70 Ultra China
codename: rothko
permalink: /firmware/rothko/stable/OS1.0.17.0.UNNCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.17.0.UNNCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware OS1.0.17.0.UNNCNXM Stable Release for Redmi K70 Ultra China (rothko)</h3>
        ...
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    style="margin: 7px;" onclick="redirect('fw_rothko_miui_ROTHKO_OS1.0.17.0.UNNCNXM_fe4c89e0aa_14.0.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
