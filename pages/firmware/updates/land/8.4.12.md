---
title: Redmi 3S Global Firmware 8.4.12 Update
layout: download
name: Redmi 3S Global
codename: land
permalink: /firmware/land/weekly/8.4.12/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware 8.4.12 Weekly Release for Redmi 3S Global (land)</h3>
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Firmware Package Name: </b><span id="filename" class="text-dark">fw_land_miui_HM3SGlobal_8.4.12_bd445ad22b_6.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">fd9493953dbdf251aab1c736a640adfe</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary"
                    style="margin: 7px;" onclick="redirect('fw_land_miui_HM3SGlobal_8.4.12_bd445ad22b_6.0.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
