---
title: Mi 9 Pro 5G China Firmware 21.11.10 Update
layout: download
name: Mi 9 Pro 5G China
codename: crux
permalink: /firmware/crux/weekly/21.11.10/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware 21.11.10 Weekly Release for Mi 9 Pro 5G China (crux)</h3>
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Firmware Package Name: </b><span id="filename" class="text-dark">fw_crux_miui_CRUX_21.11.10_998f701798_11.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">59bf73c637029e52dca4fa7a24e6f529</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary"
                    style="margin: 7px;" onclick="redirect('fw_crux_miui_CRUX_21.11.10_998f701798_11.0.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
