---
title: Mi MIX 3 China Firmware 9.9.3 Update
layout: download
name: Mi MIX 3 China
codename: perseus
permalink: /firmware/perseus/weekly/9.9.3/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware 9.9.3 Weekly Release for Mi MIX 3 China (perseus)</h3>
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Firmware Package Name: </b><span id="filename" class="text-dark">fw_perseus_miui_MIMIX3_9.9.3_a9dbc91c30_9.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">bf698dced9f02a33093155e83cb9b898</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary"
                    style="margin: 7px;" onclick="redirect('fw_perseus_miui_MIMIX3_9.9.3_a9dbc91c30_9.0.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
