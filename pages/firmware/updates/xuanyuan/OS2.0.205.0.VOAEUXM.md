---
title: Xiaomi 15 Ultra EEA Firmware OS2.0.205.0.VOAEUXM Update
layout: download
name: Xiaomi 15 Ultra EEA
codename: xuanyuan
permalink: /firmware/xuanyuan/stable/OS2.0.205.0.VOAEUXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware OS2.0.205.0.VOAEUXM Stable Release for Xiaomi 15 Ultra EEA (xuanyuan)</h3>
        ...
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    style="margin: 7px;" onclick="redirect('fw_xuanyuan_eea_global_xuanyuan_eea_global-ota_full-OS2.0.205.0.VOAEUXM-user-15.0-c4d6b272ed.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
