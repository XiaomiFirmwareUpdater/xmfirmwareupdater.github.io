---
title: Xiaomi 14 Pro / Ti China Firmware OS1.0.26.0.UNBCNXM Update
layout: download
name: Xiaomi 14 Pro / Ti China
codename: shennong
permalink: /firmware/shennong/stable/OS1.0.26.0.UNBCNXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">Firmware OS1.0.26.0.UNBCNXM Stable Release for Xiaomi 14 Pro / Ti China (shennong)</h3>
        ...
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    style="margin: 7px;" onclick="redirect('fw_shennong_miui_SHENNONG_OS1.0.26.0.UNBCNXM_57d288267f_14.0.zip'); return false;"><i class="fa fa-download"></i> Flashable Firmware</button></h5>
                </li>
            </ul>
        </div>
        </div>
