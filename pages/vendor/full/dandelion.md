---
title: Redmi 9A/Redmi 10A/10A Sport/9AT/9i/9A Sport (dandelion) Vendor Downloads
layout: download
name: Redmi 9A/Redmi 10A/10A Sport/9AT/9i/9A Sport
codename: dandelion
permalink: /archive/vendor/dandelion/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/dandelion/">Redmi 9A/Redmi 10A/10A Sport/9AT/9i/9A Sport</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/vendor/dandelion/" class="card-link">Latest Vendor</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('dandelion', 'full')</script>
            </table>
        </div>
    </div>
