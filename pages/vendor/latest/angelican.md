---
title: Redmi 9C NFC (angelican) Vendor Downloads
layout: download
name: Redmi 9C NFC
codename: angelican
permalink: /vendor/angelican/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/angelican/">Redmi 9C NFC</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/angelican/" class="card-link">Vendor Archive</a>
    <a href="/miui/angelican/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('angelican', 'latest')</script>
            </table>
        </div>
    </div>
