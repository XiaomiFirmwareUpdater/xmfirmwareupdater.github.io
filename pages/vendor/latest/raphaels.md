---
title: Redmi K20 Pro Premium Edition (raphaels) Vendor Downloads
layout: download
name: Redmi K20 Pro Premium Edition
codename: raphaels
permalink: /vendor/raphaels/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/raphaels/">Redmi K20 Pro Premium Edition</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/raphaels/" class="card-link">Vendor Archive</a>
    <a href="/miui/raphaels/" class="card-link">MIUI Downloads</a>
    <a href="/firmware/raphaels/" class="card-link">Firmware Downloads</a>
  </div>
</div>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('raphaels', 'latest')</script>
            </table>
        </div>
    </div>
