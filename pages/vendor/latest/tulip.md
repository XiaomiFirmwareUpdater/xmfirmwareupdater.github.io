---
title: Redmi Note 6 Pro (tulip) Vendor Downloads
layout: download
name: Redmi Note 6 Pro
codename: tulip
permalink: /vendor/tulip/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/tulip/">Redmi Note 6 Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/tulip/" class="card-link">Vendor Archive</a>
    <a href="/miui/tulip/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('tulip', 'latest')</script>
            </table>
        </div>
    </div>
