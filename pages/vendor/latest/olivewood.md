---
title: Redmi 8A Pro/Redmi 8A Dual (olivewood) Vendor Downloads
layout: download
name: Redmi 8A Pro/Redmi 8A Dual
codename: olivewood
permalink: /vendor/olivewood/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/olivewood/">Redmi 8A Pro/Redmi 8A Dual</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/olivewood/" class="card-link">Vendor Archive</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('olivewood', 'latest')</script>
            </table>
        </div>
    </div>
