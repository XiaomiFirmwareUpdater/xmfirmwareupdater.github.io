...
name: Mi 8 Pro
codename: equuleus
permalink: /vendor/equuleus/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/equuleus/">Mi 8 Pro</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/equuleus/" class="card-link">Vendor Archive</a>
    <a href="/miui/equuleus/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('equuleus', 'latest')</script>
            </table>
        </div>
    </div>
