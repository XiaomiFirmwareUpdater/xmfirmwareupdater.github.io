---
title: Redmi Note 9S/Redmi Note 9 Pro/Redmi Note 10 Lite (curtana) Vendor Downloads
layout: download
name: Redmi Note 9S/Redmi Note 9 Pro/Redmi Note 10 Lite
codename: curtana
permalink: /vendor/curtana/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item"><a href="/vendor/">Vendor</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="/vendor/curtana/">Redmi Note 9S/Redmi Note 9 Pro/Redmi Note 10 Lite</a></li>
    </ol>
</nav>
...
<div class="card">
  <div class="card-body">
    ...
    <a href="/archive/vendor/curtana/" class="card-link">Vendor Archive</a>
    <a href="/miui/curtana/" class="card-link">MIUI Downloads</a>
    ...
    <div class="col-10">
        <div class="table-responsive-md" style="margin-top: 25px;">
            ...
            <table id="vendor" class="display dt-responsive nowrap compact table table-striped table-hover table-sm">
                ...
                <script>loadVendorDownloads('curtana', 'latest')</script>
            </table>
        </div>
    </div>
