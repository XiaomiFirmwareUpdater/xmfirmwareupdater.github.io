---
title: Redmi Note 11 Pro+ 5G Global HyperOS OS1.0.17.0.TKTMIXM Update
layout: download
name: Redmi Note 11 Pro+ 5G Global
codename: pissarro
permalink: /hyperos/pissarro/stable/OS1.0.17.0.TKTMIXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.17.0.TKTMIXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.17.0.TKTMIXM Stable Official Update for Redmi Note 11 Pro+ 5G Global (pissarro)</h3>
    <h5>This page shows the OS1.0.17.0.TKTMIXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.17.0.TKTMIXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">pissarro_global_images_OS1.0.17.0.TKTMIXM_20250401.0000.00_13.0_global_fbf41cd5ff.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">fbf41cd5ffaa41979c76d73dae31c7c1</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
