---
title: Redmi K40 Pro / Pro+ China HyperOS OS1.0.11.0.UKKCNXM Update
layout: download
name: Redmi K40 Pro / Pro+ China
codename: haydn
permalink: /hyperos/haydn/stable beta/OS1.0.11.0.UKKCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.11.0.UKKCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.11.0.UKKCNXM Stable Beta Official Update for Redmi K40 Pro / Pro+ China (haydn)</h3>
    <h5>This page shows the OS1.0.11.0.UKKCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.11.0.UKKCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
