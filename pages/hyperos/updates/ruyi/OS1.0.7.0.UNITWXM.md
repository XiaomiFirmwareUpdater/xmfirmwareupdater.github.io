---
title: MIX Flip Taiwan HyperOS OS1.0.7.0.UNITWXM Update
layout: download
name: MIX Flip Taiwan
codename: ruyi
permalink: /hyperos/ruyi/stable/OS1.0.7.0.UNITWXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.0.UNITWXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.0.UNITWXM Stable Official Update for MIX Flip Taiwan (ruyi)</h3>
    <h5>This page shows the OS1.0.7.0.UNITWXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.0.UNITWXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="ruyi_1_changelog">
                        <p id="changelog_text">[System]<br>Optimization: System stability<br>Optimization: App launching algorithm speeds up app opening process<br>Fix: Changing wallpapers led to errors<br>Updated the security patch to September 2024. Increased system security.</p>
                    </div>
                </li>
            </ul>
        </div>
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">aadf15e9733b720124361c36f8f2477b</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://cdnorg.d.miui.com/OS1.0.7.0.UNITWXM/ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 1</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bkt-sgp-miui-ota-update-alisgp.oss-ap-southeast-1.aliyuncs.com/OS1.0.7.0.UNITWXM/ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 2</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bn.d.miui.com/OS1.0.7.0.UNITWXM/ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 3</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bigota.d.miui.com/OS1.0.7.0.UNITWXM/ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 4</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://hugeota.d.miui.com/OS1.0.7.0.UNITWXM/ruyi_tw_global_images_OS1.0.7.0.UNITWXM_20241011.0000.00_14.0_tw_aadf15e973.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 5</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
