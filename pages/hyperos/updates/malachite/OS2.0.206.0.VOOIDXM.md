---
title: Redmi Note 14 Pro 5G / POCO X7 Indonesia HyperOS OS2.0.206.0.VOOIDXM Update
layout: download
name: Redmi Note 14 Pro 5G / POCO X7 Indonesia
codename: malachite
permalink: /hyperos/malachite/stable/OS2.0.206.0.VOOIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS2.0.206.0.VOOIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS2.0.206.0.VOOIDXM Stable Official Update for Redmi Note 14 Pro 5G / POCO X7 Indonesia (malachite)</h3>
    <h5>This page shows the OS2.0.206.0.VOOIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS2.0.206.0.VOOIDXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
