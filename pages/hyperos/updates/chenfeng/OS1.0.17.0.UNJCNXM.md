---
title: Xiaomi Civi 4 Pro China HyperOS OS1.0.17.0.UNJCNXM Update
layout: download
name: Xiaomi Civi 4 Pro China
codename: chenfeng
permalink: /hyperos/chenfeng/stable beta/OS1.0.17.0.UNJCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.17.0.UNJCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.17.0.UNJCNXM Stable Beta Official Update for Xiaomi Civi 4 Pro China (chenfeng)</h3>
    <h5>This page shows the OS1.0.17.0.UNJCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.17.0.UNJCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="chenfeng_1_changelog">
                        <p id="changelog_text">[System]<br>Updated the security patch to October 2024. Increased system security.<br>[Screen Time]<br>Fix: On rare occasions, time stats weren't displayed in Screen time</p>
                    </div>
                </li>
            </ul>
        </div>
