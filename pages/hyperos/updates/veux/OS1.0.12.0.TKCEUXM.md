---
title: Redmi Note 11 Pro 5G / POCO X4 Pro 5G EEA HyperOS OS1.0.12.0.TKCEUXM Update
layout: download
name: Redmi Note 11 Pro 5G / POCO X4 Pro 5G EEA
codename: veux
permalink: /hyperos/veux/stable beta/OS1.0.12.0.TKCEUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.12.0.TKCEUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.12.0.TKCEUXM Stable Beta Official Update for Redmi Note 11 Pro 5G / POCO X4 Pro 5G EEA (veux)</h3>
    <h5>This page shows the OS1.0.12.0.TKCEUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.12.0.TKCEUXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
