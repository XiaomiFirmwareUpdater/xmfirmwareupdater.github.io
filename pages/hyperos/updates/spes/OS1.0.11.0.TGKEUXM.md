---
title: Redmi Note 11 NFC EEA HyperOS OS1.0.11.0.TGKEUXM Update
layout: download
name: Redmi Note 11 NFC EEA
codename: spes
permalink: /hyperos/spes/stable/OS1.0.11.0.TGKEUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.11.0.TGKEUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.11.0.TGKEUXM Stable Official Update for Redmi Note 11 NFC EEA (spes)</h3>
    <h5>This page shows the OS1.0.11.0.TGKEUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.11.0.TGKEUXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
