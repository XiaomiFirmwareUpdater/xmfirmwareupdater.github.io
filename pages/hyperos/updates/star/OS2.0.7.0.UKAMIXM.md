---
title: Mi 11 Ultra Global HyperOS OS2.0.7.0.UKAMIXM Update
layout: download
name: Mi 11 Ultra Global
codename: star
permalink: /hyperos/star/stable beta/OS2.0.7.0.UKAMIXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS2.0.7.0.UKAMIXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS2.0.7.0.UKAMIXM Stable Beta Official Update for Mi 11 Ultra Global (star)</h3>
    <h5>This page shows the OS2.0.7.0.UKAMIXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS2.0.7.0.UKAMIXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
