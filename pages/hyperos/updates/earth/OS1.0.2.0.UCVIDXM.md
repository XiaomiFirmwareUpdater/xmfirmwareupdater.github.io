---
title: Redmi 12C / POCO C55 Indonesia HyperOS OS1.0.2.0.UCVIDXM Update
layout: download
name: Redmi 12C / POCO C55 Indonesia
codename: earth
permalink: /hyperos/earth/stable/OS1.0.2.0.UCVIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.2.0.UCVIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.2.0.UCVIDXM Stable Official Update for Redmi 12C / POCO C55 Indonesia (earth)</h3>
    <h5>This page shows the OS1.0.2.0.UCVIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.2.0.UCVIDXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">cce87ca3ddb8091c55d1cf125772f4f5</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
