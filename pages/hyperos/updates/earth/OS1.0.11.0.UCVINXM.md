---
title: Redmi 12C / POCO C55 India HyperOS OS1.0.11.0.UCVINXM Update
layout: download
name: Redmi 12C / POCO C55 India
codename: earth
permalink: /hyperos/earth/stable/OS1.0.11.0.UCVINXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.11.0.UCVINXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.11.0.UCVINXM Stable Official Update for Redmi 12C / POCO C55 India (earth)</h3>
    <h5>This page shows the OS1.0.11.0.UCVINXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.11.0.UCVINXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
