---
title: Redmi 12C / POCO C55 Indonesia HyperOS OS1.0.7.0.UCVIDXM Update
layout: download
name: Redmi 12C / POCO C55 Indonesia
codename: earth
permalink: /hyperos/earth/stable/OS1.0.7.0.UCVIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.0.UCVIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.0.UCVIDXM Stable Official Update for Redmi 12C / POCO C55 Indonesia (earth)</h3>
    <h5>This page shows the OS1.0.7.0.UCVIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.0.UCVIDXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">earth_id_global_images_OS1.0.7.0.UCVIDXM_20250218.0000.00_14.0_id_fb286d6b1c.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">fb286d6b1cce2804ad1031db5116b663</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
