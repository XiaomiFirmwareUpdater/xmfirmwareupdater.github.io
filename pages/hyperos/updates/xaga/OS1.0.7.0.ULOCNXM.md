---
title: Redmi Note 11T Pro / Pro+ China HyperOS OS1.0.7.0.ULOCNXM Update
layout: download
name: Redmi Note 11T Pro / Pro+ China
codename: xaga
permalink: /hyperos/xaga/stable/OS1.0.7.0.ULOCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.0.ULOCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.0.ULOCNXM Stable Official Update for Redmi Note 11T Pro / Pro+ China (xaga)</h3>
    <h5>This page shows the OS1.0.7.0.ULOCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.0.ULOCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
