---
title: MIX Fold 4 China HyperOS OS3.0.5.0.WNVCNXM Update
layout: download
name: MIX Fold 4 China
codename: goku
permalink: /hyperos/goku/stable/OS3.0.5.0.WNVCNXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS3.0.5.0.WNVCNXM Stable Official Update for MIX Fold 4 China (goku)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="goku_1_changelog">
                        <p id="changelog_text">[System]<br>Optimization: System stability<br>Fix: Errors occurred in some cases<br>Fix: Occasional display glitches when opening or closing apps<br>Updated the security patch to November 2025. Increased system security.</p>
                    </div>
                </li>
            </ul>
        </div>
