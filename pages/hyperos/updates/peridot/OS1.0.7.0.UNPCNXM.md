---
title: Redmi Turbo 3 China HyperOS OS1.0.7.0.UNPCNXM Update
layout: download
name: Redmi Turbo 3 China
codename: peridot
permalink: /hyperos/peridot/stable/OS1.0.7.0.UNPCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.0.UNPCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.0.UNPCNXM Stable Official Update for Redmi Turbo 3 China (peridot)</h3>
    <h5>This page shows the OS1.0.7.0.UNPCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.0.UNPCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
