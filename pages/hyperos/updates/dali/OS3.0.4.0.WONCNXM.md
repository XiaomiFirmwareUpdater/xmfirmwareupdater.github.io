---
title: Redmi K80 Ultra China HyperOS OS3.0.4.0.WONCNXM Update
layout: download
name: Redmi K80 Ultra China
codename: dali
permalink: /hyperos/dali/stable/OS3.0.4.0.WONCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS3.0.4.0.WONCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS3.0.4.0.WONCNXM Stable Official Update for Redmi K80 Ultra China (dali)</h3>
    <h5>This page shows the OS3.0.4.0.WONCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS3.0.4.0.WONCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="dali_1_changelog">
                        <p id="changelog_text">[System]<br>Optimization: System stability<br>Fix: Errors occurred in some cases<br>Updated the security patch to October 2025. Increased system security.<br>[Floating windows]<br>Fix: Issues with floating windows in some cases</p>
                    </div>
                </li>
            </ul>
        </div>
