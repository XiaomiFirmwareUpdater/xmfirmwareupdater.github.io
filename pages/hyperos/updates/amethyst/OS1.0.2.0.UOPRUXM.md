---
title: Redmi Note 14 Pro+ 5G Russia HyperOS OS1.0.2.0.UOPRUXM Update
layout: download
name: Redmi Note 14 Pro+ 5G Russia
codename: amethyst
permalink: /hyperos/amethyst/stable/OS1.0.2.0.UOPRUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.2.0.UOPRUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.2.0.UOPRUXM Stable Official Update for Redmi Note 14 Pro+ 5G Russia (amethyst)</h3>
    <h5>This page shows the OS1.0.2.0.UOPRUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">amethyst_ru_global_images_OS1.0.2.0.UOPRUXM_20241106.0000.00_14.0_ru_b1693400da.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">b1693400da0f38ecfada315d8993e9d9</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
