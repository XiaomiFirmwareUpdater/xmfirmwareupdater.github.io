---
title: Redmi K60 Ultra China HyperOS OS1.0.7.3.UMLCNXM Update
layout: download
name: Redmi K60 Ultra China
codename: corot
permalink: /hyperos/corot/stable/OS1.0.7.3.UMLCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.3.UMLCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.3.UMLCNXM Stable Official Update for Redmi K60 Ultra China (corot)</h3>
    <h5>This page shows the OS1.0.7.3.UMLCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.3.UMLCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
