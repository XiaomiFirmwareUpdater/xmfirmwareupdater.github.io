---
title: Redmi Note 11S 4G / POCO M4 Pro 4G Taiwan HyperOS OS1.0.7.0.TKETWXM Update
layout: download
name: Redmi Note 11S 4G / POCO M4 Pro 4G Taiwan
codename: fleur
permalink: /hyperos/fleur/stable beta/OS1.0.7.0.TKETWXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.7.0.TKETWXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.7.0.TKETWXM Stable Beta Official Update for Redmi Note 11S 4G / POCO M4 Pro 4G Taiwan (fleur)</h3>
    <h5>This page shows the OS1.0.7.0.TKETWXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.7.0.TKETWXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
