---
title: Xiaomi 13 Russia HyperOS OS2.0.201.0.VMCRUXM Update
layout: download
name: Xiaomi 13 Russia
codename: fuxi
permalink: /hyperos/fuxi/stable/OS2.0.201.0.VMCRUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS2.0.201.0.VMCRUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS2.0.201.0.VMCRUXM Stable Official Update for Xiaomi 13 Russia (fuxi)</h3>
    <h5>This page shows the OS2.0.201.0.VMCRUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS2.0.201.0.VMCRUXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
