---
title: Redmi Note 12 Pro 4G Indonesia HyperOS OS1.0.23.0.THGIDXM Update
layout: download
name: Redmi Note 12 Pro 4G Indonesia
codename: sweet
permalink: /hyperos/sweet/stable beta/OS1.0.23.0.THGIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.23.0.THGIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.23.0.THGIDXM Stable Beta Official Update for Redmi Note 12 Pro 4G Indonesia (sweet)</h3>
    <h5>This page shows the OS1.0.23.0.THGIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.23.0.THGIDXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
