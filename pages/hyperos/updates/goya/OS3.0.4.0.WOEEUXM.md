---
title: Xiaomi 15T EEA HyperOS OS3.0.4.0.WOEEUXM Update
layout: download
name: Xiaomi 15T EEA
codename: goya
permalink: /hyperos/goya/stable/OS3.0.4.0.WOEEUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS3.0.4.0.WOEEUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS3.0.4.0.WOEEUXM Stable Official Update for Xiaomi 15T EEA (goya)</h3>
    <h5>This page shows the OS3.0.4.0.WOEEUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS3.0.4.0.WOEEUXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="goya_1_changelog">
                        <p id="changelog_text">[System]<br>Fix: Power consumption was higher than expected in some cases</p>
                    </div>
                </li>
            </ul>
        </div>
