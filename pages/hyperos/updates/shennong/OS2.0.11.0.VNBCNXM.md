---
title: Xiaomi 14 Pro / Ti China HyperOS OS2.0.11.0.VNBCNXM Update
layout: download
name: Xiaomi 14 Pro / Ti China
codename: shennong
permalink: /hyperos/shennong/stable beta/OS2.0.11.0.VNBCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS2.0.11.0.VNBCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS2.0.11.0.VNBCNXM Stable Beta Official Update for Xiaomi 14 Pro / Ti China (shennong)</h3>
    <h5>This page shows the OS2.0.11.0.VNBCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS2.0.11.0.VNBCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
