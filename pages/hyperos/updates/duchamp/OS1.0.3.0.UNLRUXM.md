---
title: POCO X6 Pro 5G Russia HyperOS OS1.0.3.0.UNLRUXM Update
layout: download
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.3.0.UNLRUXM</li>
    </ol>
</nav>
    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_DUCHAMPRUGlobal_OS1.0.3.0.UNLRUXM_84860639de_14.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
