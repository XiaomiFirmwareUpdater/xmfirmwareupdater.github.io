---
title: Xiaomi Pad 6S Pro 12.4 China HyperOS OS3.0.3.0.WNXCNXM Update
layout: download
name: Xiaomi Pad 6S Pro 12.4 China
codename: sheng
permalink: /hyperos/sheng/stable/OS3.0.3.0.WNXCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS3.0.3.0.WNXCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS3.0.3.0.WNXCNXM Stable Official Update for Xiaomi Pad 6S Pro 12.4 China (sheng)</h3>
    <h5>This page shows the OS3.0.3.0.WNXCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS3.0.3.0.WNXCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
