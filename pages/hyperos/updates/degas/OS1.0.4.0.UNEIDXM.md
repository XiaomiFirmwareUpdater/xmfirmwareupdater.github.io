---
title: Xiaomi 14T Indonesia HyperOS OS1.0.4.0.UNEIDXM Update
layout: download
name: Xiaomi 14T Indonesia
codename: degas
permalink: /hyperos/degas/stable/OS1.0.4.0.UNEIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.4.0.UNEIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.4.0.UNEIDXM Stable Official Update for Xiaomi 14T Indonesia (degas)</h3>
    <h5>This page shows the OS1.0.4.0.UNEIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">degas_id_global_images_OS1.0.4.0.UNEIDXM_20240920.0000.00_14.0_id_7b5c5d143c.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">7b5c5d143c3efa9bdda27207d1b06a9b</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
