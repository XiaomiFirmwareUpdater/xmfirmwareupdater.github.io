---
title: Xiaomi Pad 5 India HyperOS OS1.0.17.0.TKXINXM Update
layout: download
name: Xiaomi Pad 5 India
codename: nabu
permalink: /hyperos/nabu/stable/OS1.0.17.0.TKXINXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.17.0.TKXINXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.17.0.TKXINXM Stable Official Update for Xiaomi Pad 5 India (nabu)</h3>
    <h5>This page shows the OS1.0.17.0.TKXINXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.17.0.TKXINXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
