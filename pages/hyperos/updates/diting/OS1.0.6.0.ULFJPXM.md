---
title: Xiaomi 12T Pro Japan HyperOS OS1.0.6.0.ULFJPXM Update
layout: download
name: Xiaomi 12T Pro Japan
codename: diting
permalink: /hyperos/diting/stable beta/OS1.0.6.0.ULFJPXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.6.0.ULFJPXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.6.0.ULFJPXM Stable Beta Official Update for Xiaomi 12T Pro Japan (diting)</h3>
    <h5>This page shows the OS1.0.6.0.ULFJPXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.6.0.ULFJPXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
