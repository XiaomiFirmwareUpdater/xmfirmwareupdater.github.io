---
title: Redmi K80 Pro China HyperOS OS2.0.11.0.VOMCNXM Update
layout: download
name: Redmi K80 Pro China
codename: miro
permalink: /hyperos/miro/stable/OS2.0.11.0.VOMCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS2.0.11.0.VOMCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS2.0.11.0.VOMCNXM Stable Official Update for Redmi K80 Pro China (miro)</h3>
    <h5>This page shows the OS2.0.11.0.VOMCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS2.0.11.0.VOMCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="miro_1_changelog">
                        <p id="changelog_text">[Other improvements and optimizations]<br>New: Enjoy CD-level sound quality with MIHC codec and REDMI Buds 6 Pro<br>Optimization: Swiping up while using full screen gestures didn't always work<br>Optimization: The animation displayed while switching between Notification shade and Control center froze in some cases<br>Fix: AI gaming services didn't always work</p>
                    </div>
                </li>
            </ul>
        </div>
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">644410800a0287161df66cdbf0f636fa</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://cdnorg.d.miui.com/OS2.0.11.0.VOMCNXM/miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 1</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bkt-sgp-miui-ota-update-alisgp.oss-ap-southeast-1.aliyuncs.com/OS2.0.11.0.VOMCNXM/miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 2</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bn.d.miui.com/OS2.0.11.0.VOMCNXM/miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 3</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://bigota.d.miui.com/OS2.0.11.0.VOMCNXM/miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 4</button> <button type="button" id="download" class="btn btn-primary" style="margin: 7px;" onclick="window.open('https://hugeota.d.miui.com/OS2.0.11.0.VOMCNXM/miro_images_OS2.0.11.0.VOMCNXM_20241130.0000.00_15.0_cn_644410800a.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM Mirror 5</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
