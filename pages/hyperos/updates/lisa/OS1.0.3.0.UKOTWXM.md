---
title: Xiaomi 11 Lite 5G NE Taiwan HyperOS OS1.0.3.0.UKOTWXM Update
layout: download
name: Xiaomi 11 Lite 5G NE Taiwan
codename: lisa
permalink: /hyperos/lisa/stable beta/OS1.0.3.0.UKOTWXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.3.0.UKOTWXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.3.0.UKOTWXM Stable Beta Official Update for Xiaomi 11 Lite 5G NE Taiwan (lisa)</h3>
    <h5>This page shows the OS1.0.3.0.UKOTWXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.3.0.UKOTWXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
