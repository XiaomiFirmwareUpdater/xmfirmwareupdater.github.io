---
title: Xiaomi 14 India HyperOS OS3.0.4.0.WNCINXM Update
layout: download
name: Xiaomi 14 India
codename: houji
permalink: /hyperos/houji/stable/OS3.0.4.0.WNCINXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS3.0.4.0.WNCINXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS3.0.4.0.WNCINXM Stable Official Update for Xiaomi 14 India (houji)</h3>
    <h5>This page shows the OS3.0.4.0.WNCINXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS3.0.4.0.WNCINXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
