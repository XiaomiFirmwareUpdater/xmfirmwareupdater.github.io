---
title: POCO X5 Pro 5G India HyperOS OS1.0.11.0.UMSINXM Update
layout: download
name: POCO X5 Pro 5G India
codename: redwood
permalink: /hyperos/redwood/stable beta/OS1.0.11.0.UMSINXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">OS1.0.11.0.UMSINXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">HyperOS OS1.0.11.0.UMSINXM Stable Beta Official Update for POCO X5 Pro 5G India (redwood)</h3>
    <h5>This page shows the OS1.0.11.0.UMSINXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>OS1.0.11.0.UMSINXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
