---
title: Redmi K50 Pro China MIUI V14.0.5.0.TLKCNXM Update
layout: download
name: Redmi K50 Pro China
codename: matisse
permalink: /miui/matisse/stable beta/V14.0.5.0.TLKCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V14.0.5.0.TLKCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V14.0.5.0.TLKCNXM Stable Beta Official Update for Redmi K50 Pro China (matisse)</h3>
    <h5>This page shows the V14.0.5.0.TLKCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V14.0.5.0.TLKCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_MATISSE_V14.0.5.0.TLKCNXM_a1a2b6a363_13.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">a1a2b6a363da868f40f0433b85228aa3</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V14.0.5.0.TLKCNXM/miui_MATISSE_V14.0.5.0.TLKCNXM_a1a2b6a363_13.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
