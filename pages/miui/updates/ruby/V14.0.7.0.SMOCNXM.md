---
title: Redmi Note 12 Pro / Pro+ / Discovery 5G China MIUI V14.0.7.0.SMOCNXM Update
layout: download
name: Redmi Note 12 Pro / Pro+ / Discovery 5G China
codename: ruby
permalink: /miui/ruby/stable/V14.0.7.0.SMOCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V14.0.7.0.SMOCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V14.0.7.0.SMOCNXM Stable Official Update for Redmi Note 12 Pro / Pro+ / Discovery 5G China (ruby)</h3>
    <h5>This page shows the V14.0.7.0.SMOCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V14.0.7.0.SMOCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
