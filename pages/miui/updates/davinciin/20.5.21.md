---
title: Redmi K20 China MIUI 20.5.21 Update
layout: download
name: Redmi K20 China
codename: davinciin
permalink: /miui/davinciin/weekly/20.5.21/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI 20.5.21 Weekly Official Update for Redmi K20 China (davinciin)</h3>
    ...
    <div id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_DAVINCI_20.5.21_a140ce2db1_10.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">a140ce2db17a3de191f044e22899edbb</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/20.5.21/miui_DAVINCI_20.5.21_a140ce2db1_10.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="davinci_1_changelog">
                        <p id="changelog_text">[??]<br>?????????2020#03?????????<br>[???]<br>?? ??????????<br>?? ??????????????<br>[????]<br>?? ???????????</p>
                    </div>
                </li>
            </ul>
        </div>
