---
title: Redmi A1 / POCO C50 Indonesia MIUI V13.0.7.0.SGMIDXM Update
layout: download
name: Redmi A1 / POCO C50 Indonesia
codename: ice
permalink: /miui/ice/stable beta/V13.0.7.0.SGMIDXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V13.0.7.0.SGMIDXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V13.0.7.0.SGMIDXM Stable Beta Official Update for Redmi A1 / POCO C50 Indonesia (ice)</h3>
    <h5>This page shows the V13.0.7.0.SGMIDXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V13.0.7.0.SGMIDXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
