...
codename: redwood
permalink: /miui/redwood/stable beta/V14.0.7.0.SMSINXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V14.0.7.0.SMSINXM Stable Beta Official Update for POCO X5 Pro 5G India (redwood)</h3>
    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V14.0.7.0.SMSINXM/redwood_in_global_images_V14.0.7.0.SMSINXM_20230208.0000.00_12.0_in_867c1f9aea.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
