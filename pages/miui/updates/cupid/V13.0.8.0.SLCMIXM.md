...
codename: cupid
permalink: /miui/cupid/stable beta/V13.0.8.0.SLCMIXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V13.0.8.0.SLCMIXM Stable Beta Official Update for Xiaomi 12 Global (cupid)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V13.0.8.0.SLCMIXM/miui_CUPIDGlobal_V13.0.8.0.SLCMIXM_acdd6e53ed_12.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button><button type="button" id="incremental_download" class="btn btn-warning" onclick="window.open('https://bigota.d.miui.com/V13.0.8.0.SLCMIXM/miui-blockota-cupid_global-V13.0.7.0.SLCMIXM-V13.0.8.0.SLCMIXM-0f20d8c996-12.0.zip', '_blank');"><i class="fa fa-download"></i> Incremental Update</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
