...
codename: ares
permalink: /miui/ares/stable beta/V14.0.5.0.TKJINXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V14.0.5.0.TKJINXM Stable Beta Official Update for POCO F3 GT India (ares)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V14.0.5.0.TKJINXM/miui_ARESINGlobal_V14.0.5.0.TKJINXM_f82c4bfd01_13.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button><button type="button" id="incremental_download" class="btn btn-warning" onclick="window.open('https://bigota.d.miui.com/V14.0.5.0.TKJINXM/miui-blockota-ares_in_global-V14.0.4.0.TKJINXM-V14.0.5.0.TKJINXM-9251d99f5f-13.0.zip', '_blank');"><i class="fa fa-download"></i> Incremental Update</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
