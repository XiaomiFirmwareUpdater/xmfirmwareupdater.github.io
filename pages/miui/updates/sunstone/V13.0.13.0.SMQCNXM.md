---
title: Redmi Note 12 5G China MIUI V13.0.13.0.SMQCNXM Update
layout: download
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V13.0.13.0.SMQCNXM Stable Official Update for Redmi Note 12 5G China (sunstone)</h3>
    ...
    <div class="row justify-content-center">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V13.0.13.0.SMQCNXM/miui_SUNSTONE_V13.0.13.0.SMQCNXM_d762b9c2bb_12.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V13.0.13.0.SMQCNXM/sunstone_images_V13.0.13.0.SMQCNXM_20230224.0000.00_12.0_cn_c9e5858e13.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
