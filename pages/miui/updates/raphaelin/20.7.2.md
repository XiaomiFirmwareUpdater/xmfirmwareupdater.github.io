---
title: Redmi K20 Pro China MIUI 20.7.2 Update
layout: download
name: Redmi K20 Pro China
codename: raphaelin
permalink: /miui/raphaelin/weekly/20.7.2/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI 20.7.2 Weekly Official Update for Redmi K20 Pro China (raphaelin)</h3>
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_RAPHAEL_20.7.2_ff7c55b420_10.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">ff7c55b420957990ce301bf1e149e3c7</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/20.7.2/miui_RAPHAEL_20.7.2_ff7c55b420_10.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button><button type="button" id="incremental_download" class="btn btn-warning" onclick="window.open('https://bigota.d.miui.com/20.7.2/miui-blockota-grus-20.6.18-20.7.2-310182f0f0-10.0.zip', '_blank');"><i class="fa fa-download"></i> Incremental Update</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    ...
                    <div class="collapse" id="raphael_1_changelog">
                        <p id="changelog_text">[系统]<br>修复 偶现退出超级省电模式后全面屏手势失效的问题<br>更新谷歌安全补丁（2020#07），提升系统安全性<br>[状态栏、通知栏]<br>修复 偶现桌面下拉状态栏失败的问题<br>[手机管家]<br>删除 病毒扫描Avast杀毒引擎</p>
                    </div>
                </li>
            </ul>
        </div>
