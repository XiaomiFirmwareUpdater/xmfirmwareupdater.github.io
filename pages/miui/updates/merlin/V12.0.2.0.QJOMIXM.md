...
codename: merlin
permalink: /miui/merlin/stable beta/V12.0.2.0.QJOMIXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V12.0.2.0.QJOMIXM Stable Beta Official Update for Redmi Note 9 Global (merlin)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V12.0.2.0.QJOMIXM/miui_MERLINGlobal_V12.0.2.0.QJOMIXM_6da6e664fd_10.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button><button type="button" id="incremental_download" class="btn btn-warning" onclick="window.open('https://bigota.d.miui.com/V12.0.2.0.QJOMIXM/miui-blockota-merlin_global-V11.0.5.0.QJOMIXM-V12.0.2.0.QJOMIXM-ceb9dda324-10.0.zip', '_blank');"><i class="fa fa-download"></i> Incremental Update</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
