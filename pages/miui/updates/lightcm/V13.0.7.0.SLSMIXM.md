...
codename: lightcm
permalink: /miui/lightcm/stable/V13.0.7.0.SLSMIXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V13.0.7.0.SLSMIXM Stable Official Update for Redmi 10 5G / POCO M4 5G Global (lightcm)</h3>
    ...
    <div class="row justify-content-center">
        ...
        <div class="card card-body">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V13.0.7.0.SLSMIXM/light_global_images_V13.0.7.0.SLSMIXM_20220923.0000.00_12.0_global_17af2ea6e9.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
