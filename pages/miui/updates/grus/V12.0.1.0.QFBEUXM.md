...
name: Mi 9 SE EEA
codename: grus
permalink: /miui/grus/stable beta/V12.0.1.0.QFBEUXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V12.0.1.0.QFBEUXM Stable Beta Official Update for Mi 9 SE EEA (grus)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V12.0.1.0.QFBEUXM/miui_GRUSEEAGlobal_V12.0.1.0.QFBEUXM_3fa8811005_10.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
