---
title: Mi A1 Global MIUI V.9.5.10.0.ODHMIFA Update
layout: download
name: Mi A1 Global
codename: tissot
permalink: /miui/tissot/stable/V.9.5.10.0.ODHMIFA/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V.9.5.10.0.ODHMIFA</li>
    </ol>
</nav>
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V.9.5.10.0.ODHMIFA</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">tissot_images_V.9.5.10.0.ODHMIFA_20180405.0000.00_8.0_b9e697ed56.tgz</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V.9.5.10.0.ODHMIFA/tissot_images_V.9.5.10.0.ODHMIFA_20180405.0000.00_8.0_b9e697ed56.tgz', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
