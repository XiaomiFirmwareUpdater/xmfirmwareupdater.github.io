---
title: Redmi 10 Global MIUI V12.5.1.0.RKUMIXM Update
layout: download
name: Redmi 10 Global
codename: selenes
permalink: /miui/selenes/stable beta/V12.5.1.0.RKUMIXM/
---
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V12.5.1.0.RKUMIXM Stable Beta Official Update for Redmi 10 Global (selenes)</h3>
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V12.5.1.0.RKUMIXM/miui_SELENEGlobal_V12.5.1.0.RKUMIXM_f3b510deb9_11.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
