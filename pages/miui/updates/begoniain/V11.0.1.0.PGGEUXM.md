---
title: Redmi Note 8 Pro EEA MIUI V11.0.1.0.PGGEUXM Update
layout: download
name: Redmi Note 8 Pro EEA
codename: begoniain
permalink: /miui/begoniain/stable/V11.0.1.0.PGGEUXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V11.0.1.0.PGGEUXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V11.0.1.0.PGGEUXM Stable Official Update for Redmi Note 8 Pro EEA (begoniain)</h3>
    <h5>This page shows the V11.0.1.0.PGGEUXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V11.0.1.0.PGGEUXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_BEGONIAEEAGlobal_V11.0.1.0.PGGEUXM_32d149b6de_9.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">32d149b6deb2a7a1c3c9e405379b1429</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V11.0.1.0.PGGEUXM/miui_BEGONIAEEAGlobal_V11.0.1.0.PGGEUXM_32d149b6de_9.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button><button type="button" id="incremental_download" class="btn btn-warning" onclick="window.open('https://bigota.d.miui.com/V11.0.1.0.PGGEUXM/miui-blockota-begonia_eea_global-V10.4.5.0.PGGEUXM-V11.0.1.0.PGGEUXM-90e7f17956-9.0.zip', '_blank');"><i class="fa fa-download"></i> Incremental Update</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
