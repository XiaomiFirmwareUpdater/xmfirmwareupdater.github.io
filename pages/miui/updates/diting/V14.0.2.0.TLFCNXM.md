---
title: Redmi K50 Ultra China MIUI V14.0.2.0.TLFCNXM Update
layout: download
name: Redmi K50 Ultra China
codename: diting
permalink: /miui/diting/stable beta/V14.0.2.0.TLFCNXM/
---
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">V14.0.2.0.TLFCNXM</li>
    </ol>
</nav>
...
<div class="col-12 mx-auto">
    <h3 class="title bg-light p-2 rounded">MIUI V14.0.2.0.TLFCNXM Stable Beta Official Update for Redmi K50 Ultra China (diting)</h3>
    <h5>This page shows the V14.0.2.0.TLFCNXM update only. If you're looking for other updates check
    ...
    <div class="row justify-content-center">
        <div class="col-10" id="downloads">
            ...
            <ul class="list-unstyled">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Version: </b>V14.0.2.0.TLFCNXM</h5>
                </li>
                <li style="padding-bottom: 10px;">
                ...
                <li style="padding-bottom: 10px;">
                    <h5><b>Package Name: </b><span id="filename" class="text-dark">miui_DITING_V14.0.2.0.TLFCNXM_4e7fa733ef_13.0.zip</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>MD5: </b><span id="md5" class="text-muted">4e7fa733efda9b1077d2fc4652470add</span></h5>
                </li>
                <li style="padding-bottom: 10px;">
                    <h5><b>Download: </b><button type="button" id="download" class="btn btn-primary" style="margin: 7px;"
                            onclick="window.open('https://bigota.d.miui.com/V14.0.2.0.TLFCNXM/miui_DITING_V14.0.2.0.TLFCNXM_4e7fa733ef_13.0.zip', '_blank');"><i class="fa fa-download"></i> Full ROM</button></h5>
                </li>
                <li style="padding-bottom: 10px;">
